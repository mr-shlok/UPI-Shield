...
const ProfessionalDashboardComplete: React.FC = () => {
  ...
  const [chatMessages, setChatMessages] = useState([
    { id: 1, text: "Hello! I'm your AI fraud protection assistant. How can I help you today?", isUser: false }
  ]);
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      if (result.transaction_id) {
        await fetch(`http://localhost:5000/api/transactions/${result.transaction_id}`, {
          method: 'PUT',
          headers: {
            'Content-Type': 'application/json',
          },
            ...
            <div className="flex items-center">
              ...
              >
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-sm text-gray-400">Professional Dashboard</span>
                </div>
              </motion.div>
            </div>
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                <input
                  ...
                  className="w-48 px-4 py-2 rounded-lg bg-gray-800/50 text-gray-300 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50"
                />
      ...
      <AnimatePresence>
        {sidebarOpen && (
          <motion.div
            ...
            className="fixed top-0 left-0 bottom-0 w-64 bg-black/95 backdrop-blur-md shadow-lg z-40"
          >
                ...
                <ul className="space-y-2">
                  <li>
                    <button
                      ...
                      className="flex items-center space-x-2 px-4 py-2 rounded-lg hover:bg-gray-700/50 text-gray-300 bg-gray-800/50 backdrop-blur-sm border border-blue-500/30"
                    >
                      <FiHome size={20} />
                      <span>Dashboard</span>
                    </button>
                  ...
                  <li>
                    <button
                      onClick={() => handleSidebarItemClick('Transactions')}
                      className="flex items-center space-x-2 px-4 py-2 rounded-lg hover:bg-gray-700/50 text-gray-300 bg-gray-800/50 backdrop-blur-sm border border-blue-500/30"
                    >
                      <FiActivity size={20} />
                  ...
                  <li>
                    <button
                      onClick={() => handleSidebarItemClick('Fraud Alerts / Reports')}
                      className="flex items-center space-x-2 px-4 py-2 rounded-lg hover:bg-gray-700/50 text-gray-300 bg-gray-800/50 backdrop-blur-sm border border-blue-500/30"
                    >
                      <FiAlertTriangle size={20} />
                      <span>Fraud Alerts / Reports</span>
                    </button>
                  </li>
                  <li>
                    <button
                      onClick={() => handleSidebarItemClick('Fraud Risk Score')}
                      className="flex items-center space-x-2 px-4 py-2 rounded-lg hover:bg-gray-700/50 text-gray-300 bg-gray-800/50 backdrop-blur-sm border border-blue-500/30"
                    >
                      <FiBarChart2 size={20} />
                  ...
                  <li>
                    <button
                      onClick={() => handleSidebarItemClick('AI Chat / Virtual Assistant')}
                      className="flex items-center space-x-2 px-4 py-2 rounded-lg hover:bg-gray-700/50 text-gray-300 bg-gray-800/50 backdrop-blur-sm border border-blue-500/30"
                    >
                      <FiMessageSquare size={20} />
                      <span>AI Chat / Virtual Assistant</span>
                    </button>
                  </li>
                  <li>
                    <button
                      onClick={() => handleSidebarItemClick('Account Security')}
                      className="flex items-center space-x-2 px-4 py-2 rounded-lg hover:bg-gray-700/50 text-gray-300 bg-gray-800/50 backdrop-blur-sm border border-blue-500/30"
                    >
                      <FiShield size={20} />
                  ...
                  <li>
                    <button
                      onClick={() => handleSidebarItemClick('Help & Support')}
                      className="flex items-center space-x-2 px-4 py-2 rounded-lg hover:bg-gray-700/50 text-gray-300 bg-gray-800/50 backdrop-blur-sm border border-blue-500/30"
                    >
              ...
              <nav className="mt-2 flex-1 px-3 space-y-1">
                {[
                  ...
                  <motion.button
                    ...
                    whileHover={{ 
                      x: 8, 
                      backgroundColor: item.name === 'Dashboard' ? 'rgba(37, 99, 235, 0.7)' : 'rgba(30, 41, 59, 0.5)',
                      boxShadow: item.name === 'Dashboard' ? '0 10px 25px rgba(59, 130, 246, 0.4)' : '0 5px 15px rgba(0, 0, 0, 0.2)'
                    }}
                    whileTap={{ scale: 0.98 }}
                  >
